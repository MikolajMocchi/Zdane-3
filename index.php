...
<body>
    ...
    <main>
        <!-- p1 -->
        <form action='./rozwiazania/p1.php' method='POST'>
        ...
        <!-- p2 -->
        <form action='./rozwiazania/p2.php' method='POST'>
        ...
        <!-- p3 -->
        <form action='./rozwiazania/p3.php' method='POST'>
            ...
            <span>
                <label for="man">
                    Men <input type="radio" name="gen" value="man" id='man'>
                </label>
                <label for="woman">
                    Women <input type="radio" name='gen' value='woman' id='woman'>
                </label>
                <label for="inny">
                    Other <input type="radio" name='gen' value='inny' id='inny'>
                </label>
                <label for="nunu">
                    Rather not say <input type="radio" name='gen' value='nunu' id='nunu'>
                </label>
            </span>
            <span>
                <button>Send</button>
        ...
        <!-- p4 -->
        <form action='./rozwiazania/p4.php' method='POST'>
            ...
            <input type="text" required placeholder="Surname here" name='surname'>
            <label for="terms">
                <input type="checkbox" id="terms" name='terms'>
                Do you agree on <a href="terms.php">terms</a>?
            </label>
        ...
        <!-- p5 -->
        <form action="./rozwiazania/p5.php" method="POST">
            ...
            <input type="text" name="name" id="name" placeholder="Your name">
            <input type="text" name="lastname" id="lastname" placeholder="Your surname">
            <input type="email" name="email" id="email" placeholder="E-mail here">
            <input type="text" name="studentindex" id="studentindex" placeholder="Student index">
            <span>
                <button name="xd">Send</button>
            </span>
        </form>
        <!-- p6 -->
        <form action="./rozwiazania/p6.php" method="POST">
            ...
            <span>
                <button name="xd2">Add</button>
            </span>
        </form>
        <!-- p7 -->
        <form action="./rozwiazania/p7.php" method="GET" id="p7">
            ...
            <span>
                ...
                <?php
                if (isset($_GET['id'])) {
                    include_once('./rozwiazania/p7.php');
                }
                ?>
                <button>Show</button>
            </span>
        ...
        <!-- p8 -->
        <form action="./rozwiazania/p8.php" method='POST'>
